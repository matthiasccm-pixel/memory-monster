...
const ActivatePlanModal = ({ 
  ...
  <div style={{
    ...
    <div style={{
      ...
      <h2 style={{ color: 'white', fontSize: '32px', fontWeight: '800', margin: '0 0 12px 0', letterSpacing: '-0.5px' }}>Unlock Full Speed</h2>
      <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '17px', margin: '0 0 32px 0', lineHeight: '1.5' }}>
        Join millions experiencing blazing Mac performance. Reclaim your speed from memory-hungry apps.
      </p>
