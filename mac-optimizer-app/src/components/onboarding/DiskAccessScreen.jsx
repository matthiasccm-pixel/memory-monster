  ...
  return (
    <div style={{ padding: '40px', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ ...cardStyle, maxWidth: '600px', width: '100%', textAlign: 'center', position: 'relative' }}>
        ...
        <h1 style={{ fontSize: '38px', fontWeight: '800', color: '#1f2937', margin: '0 0 16px 0', letterSpacing: '-1.2px' }}>Unlock Your Mac's Hidden Speed</h1>
        <p style={{ color: '#6b7280', fontSize: '19px', margin: '0 0 32px 0', fontWeight: '500', lineHeight: '1.5' }}>
          Memory Monster needs access to analyze which apps are slowing you down and reveal exactly how much speed you can gain.
        </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', margin: '32px 0 40px 0' }}>
          <div style={{ padding: '16px', background: 'rgba(114, 9, 183, 0.1)', borderRadius: '16px', border: '1px solid rgba(114, 9, 183, 0.2)' }}>
            ...
            <div style={{ fontSize: '14px', fontWeight: '600', color: '#1f2937' }}>Measure Real Speed</div>
          </div>
          <div style={{ padding: '16px', background: 'rgba(83, 52, 131, 0.1)', borderRadius: '16px', border: '1px solid rgba(83, 52, 131, 0.2)' }}>
            <div style={{ fontSize: '24px', marginBottom: '8px' }}>💪</div>
            <div style={{ fontSize: '14px', fontWeight: '600', color: '#1f2937' }}>Reclaim Performance</div>
          </div>
        </div>
